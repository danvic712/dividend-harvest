...
export default function App() {
  ...
  function renderPage() {
    if (path === "/setup") return <SetupPage onComplete={() => { setSetupStatus({ isComplete: true, missingRequirements: [] }); navigate("/overview") }} />
    ...
    return <RecommendationsPage onNavigate={navigate} />
  }
